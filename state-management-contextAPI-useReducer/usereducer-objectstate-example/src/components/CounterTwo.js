...
function CounterTwo() {
	...
	return (
		<div>
			...
			<button onClick={() => dispatch({ type: 'increment', payload: { incBy: 1 } })}>Increment Counter One by 1</button>
			<br />
			<button onClick={() => dispatch({ type: 'decrement', payload: { decBy: 1 } })}>Decrement Counter One by 1</button>
			<br />
			<button onClick={() => dispatch({ type: 'increment', payload: { incBy: 5 } })}>Increment Counter One by 5</button>
			<br />
			<button onClick={() => dispatch({ type: 'decrement', payload: { decBy: 5 } })}>Decrement Counter One by 5</button>
			<br />
