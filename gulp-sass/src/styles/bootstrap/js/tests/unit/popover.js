$(function () {
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      assert.strictEqual(
        $('.popover .popover-body').html().toLowerCase(),
        '<i>¯\\_(ツ)_/¯</i>',
        'content inserted'
      );
      assert.ok(
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var done = assert.async();
      var $div = $(
        '<div><a href="#" title="mdo" data-content="https://twitter.com/mdo">@mdo</a></div>'
      )
        .appendTo('#qunit-fixture')
        .bootstrapPopover({
          selector: 'a',
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $popover = $(
        ...
        .bootstrapPopover('hide');
      assert.strictEqual(
        typeof $popover.data('bs.popover'),
        'undefined',
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      try {
        $(
          '<div data-toggle="popover" data-title="some title" data-content="@Johann-S" style="display: none"/>'
        ).bootstrapPopover('show');
      } catch (err) {
  ...
  QUnit.test(
    'should convert number to string without error for content and title',
    function (assert) {
      assert.expect(2);
      var done = assert.async();
  ...
  QUnit.test(
    'popover should be shown right away after the call of disable/enable',
    function (assert) {
      assert.expect(2);
      var done = assert.async();
      var $popover = $('<a href="#">@mdo</a>')
