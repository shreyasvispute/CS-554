$(function () {
  ...
  QUnit.test('should show multiple collapsed elements', function (assert) {
    ...
    var done = assert.async();
    var $target = $(
      '<a role="button" data-toggle="collapse" class="collapsed" href=".multi"/>'
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $target1 = $(
        '<a role="button" data-toggle="collapse" href="#body1" />'
      ).appendTo($groups.eq(0));

      $('<div id="body1" class="show" data-parent="#accordion"/>').appendTo(
        $groups.eq(0)
      );

      var $target2 = $(
        '<a class="collapsed" data-toggle="collapse" role="button" href="#body2" />'
      ).appendTo($groups.eq(1));

      $('<div id="body2" data-parent="#accordion"/>').appendTo($groups.eq(1));

      var $target3 = $(
        '<a class="collapsed" data-toggle="collapse" role="button" href="#body3" />'
  ...
  QUnit.test(
    'should set aria-expanded="true" on trigger/control when collapse is shown',
    function (assert) {
      assert.expect(1);
      var done = assert.async();
  ...
  QUnit.test(
    'should set aria-expanded="false" on trigger/control when collapse is hidden',
    function (assert) {
      assert.expect(1);
      var done = assert.async();
      ...
      $('<div id="test1"/>')
        ...
        .on('shown.bs.collapse', function () {
          assert.strictEqual(
            $target.attr('aria-expanded'),
            'true',
            'aria-expanded on trigger/control is "true"'
          );
          assert.strictEqual(
            $alt.attr('aria-expanded'),
            'true',
            'aria-expanded on alternative trigger/control is "true"'
          );
          done();
        });
      ...
      $('<div id="test1" class="show"/>')
        ...
        .on('hidden.bs.collapse', function () {
          assert.strictEqual(
            $target.attr('aria-expanded'),
            'false',
            'aria-expanded on trigger/control is "false"'
          );
          assert.strictEqual(
            $alt.attr('aria-expanded'),
            'false',
            'aria-expanded on alternative trigger/control is "false"'
          );
          done();
        });
  ...
  QUnit.test(
    'should change aria-expanded from active accordion trigger/control to "false" and set the trigger/control for the newly active one to "true"',
    function (assert) {
      assert.expect(3);
      var done = assert.async();
      ...
      var $target1 = $(
        '<a role="button" data-toggle="collapse" aria-expanded="true" href="#body1"/>'
      ).appendTo($groups.eq(0));
      ...
      var $target2 = $(
        '<a role="button" data-toggle="collapse" aria-expanded="false" href="#body2" class="collapsed" aria-expanded="false" />'
      ).appendTo($groups.eq(1));

      $('<div id="body2" data-parent="#accordion"/>').appendTo($groups.eq(1));

      var $target3 = $(
        '<a class="collapsed" data-toggle="collapse" aria-expanded="false" role="button" href="#body3"/>'
      ).appendTo($groups.eq(2));
      ...
      $('<div id="body3" data-parent="#accordion"/>')
        ...
        .on('shown.bs.collapse', function () {
          assert.strictEqual(
            ...
            'false',
            'inactive trigger/control 1 has aria-expanded="false"'
          );
          assert.strictEqual(
            $target2.attr('aria-expanded'),
            'false',
            'inactive trigger/control 2 has aria-expanded="false"'
          );
          assert.strictEqual(
            $target3.attr('aria-expanded'),
            'true',
            'active trigger/control 3 has aria-expanded="true"'
          );
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $target2 = $(
        '<a role="button" data-toggle="collapse" href="#body2"/>'
      ).appendTo($groups.eq(1));
      var $body2 = $(
        '<div id="body2" class="collapse" data-parent="#accordion"/>'
      ).appendTo($groups.eq(1));
  ...
  QUnit.test(
    'should allow accordion to use children other than card',
    function (assert) {
      assert.expect(4);
      var done = assert.async();
      var accordionHTML =
  ...
  QUnit.test('should allow accordion to contain nested elements', function (
    assert
  ) {
    assert.expect(4);
    var done = assert.async();
  ...
  QUnit.test('should allow accordion to target multiple elements', function (
    assert
  ) {
    assert.expect(8);
    var done = assert.async();
    ...
    function firstTest() {
      ...
      assert.ok(
        !$collapseTwoOne.hasClass('show'),
        '#collapseTwoOne is not shown'
      );
      assert.ok(
        !$collapseTwoTwo.hasClass('show'),
    ...
    function secondTest() {
      assert.ok(
        !$collapseOneOne.hasClass('show'),
        '#collapseOneOne is not shown'
      );
      assert.ok(
        !$collapseOneTwo.hasClass('show'),
        '#collapseOneTwo is not shown'
      );
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $collapseOne.one('shown.bs.collapse', function () {
        ...
        assert.ok(!$collapseTwo.hasClass('show'), '#collapseTwo is not shown');
        assert.ok(
          !$('#nestedCollapseOne').hasClass('show'),
          '#nestedCollapseOne is not shown'
        );
  ...
  QUnit.test(
    'should add "collapsed" class to triggers only when all the targeted collapse are hidden',
    function (assert) {
      assert.expect(9);
      var done = assert.async();
      ...
      var $trigger2 = $(
        '<a role="button" data-toggle="collapse" href="#test2"/>'
      ).appendTo('#qunit-fixture');
      var $trigger3 = $(
        '<a role="button" data-toggle="collapse" href=".multi"/>'
      ).appendTo('#qunit-fixture');

      var $target1 = $('<div id="test1" class="multi"/>').appendTo(
        '#qunit-fixture'
      );
      var $target2 = $('<div id="test2" class="multi"/>').appendTo(
        '#qunit-fixture'
      );

      $target2.one('shown.bs.collapse', function () {
        assert.ok(
          !$trigger1.hasClass('collapsed'),
          'trigger1 does not have collapsed class'
        );
        assert.ok(
          !$trigger2.hasClass('collapsed'),
          'trigger2 does not have collapsed class'
        );
        assert.ok(
          !$trigger3.hasClass('collapsed'),
          'trigger3 does not have collapsed class'
        );
  ...
  QUnit.test(
    'should set aria-expanded="true" to triggers targeting shown collaspe and aria-expanded="false" only when all the targeted collapses are shown',
    function (assert) {
      assert.expect(9);
      var done = assert.async();
      ...
      var $target1 = $('<div id="test1" class="multi collapse"/>').appendTo(
        '#qunit-fixture'
      );
      var $target2 = $('<div id="test2" class="multi collapse"/>').appendTo(
        '#qunit-fixture'
      );

      $target2.one('shown.bs.collapse', function () {
        assert.strictEqual(
          $trigger1.attr('aria-expanded'),
          'true',
          'aria-expanded on trigger1 is "true"'
        );
        assert.strictEqual(
          $trigger2.attr('aria-expanded'),
          'true',
          'aria-expanded on trigger2 is "true"'
        );
        assert.strictEqual(
          $trigger3.attr('aria-expanded'),
          'true',
          'aria-expanded on trigger3 is "true"'
        );
        $target2.one('hidden.bs.collapse', function () {
          assert.strictEqual(
            $trigger1.attr('aria-expanded'),
          ...
          assert.strictEqual(
            $trigger2.attr('aria-expanded'),
            'false',
            'aria-expanded on trigger2 is "false"'
          );
          assert.strictEqual(
            $trigger3.attr('aria-expanded'),
            'true',
          ...
          $target1.one('hidden.bs.collapse', function () {
            assert.strictEqual(
              $trigger1.attr('aria-expanded'),
              'false',
              'aria-expanded on trigger1 is "fasle"'
            );
            assert.strictEqual(
              $trigger2.attr('aria-expanded'),
              'false',
            ...
            assert.strictEqual(
              $trigger3.attr('aria-expanded'),
              'false',
              'aria-expanded on trigger3 is "false"'
            );
            done();
          });
          $trigger1.trigger('click');
  ...
  QUnit.test(
    'should not prevent interactions inside the collapse element',
    function (assert) {
      assert.expect(2);
      var done = assert.async();
  ...
  QUnit.test(
    'should find collapse children if they have collapse class too not only data-parent',
    function (assert) {
      assert.expect(2);
      var done = assert.async();
