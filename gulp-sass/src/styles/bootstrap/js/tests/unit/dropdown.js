$(function () {
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $dropdown.parent('.dropdown').on('shown.bs.dropdown', function () {
        assert.ok(
          !$dropdown.parent('.dropdown').hasClass('position-static'),
  ...
  QUnit.test('should add class show to menu if clicked', function (assert) {
    ...
    $dropdown.parent('.dropdown').on('shown.bs.dropdown', function () {
      assert.ok(
        $dropdown.parent('.dropdown').hasClass('show'),
  ...
  QUnit.test('should remove "show" class if body is clicked', function (
    assert
  ) {
    assert.expect(2);
    var done = assert.async();
  ...
  QUnit.test('should remove "show" class if tabbing outside of menu', function (
    assert
  ) {
    assert.expect(2);
    var done = assert.async();
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $first
        ...
        .on('shown.bs.dropdown', function () {
          assert.strictEqual(
            $first.parents('.show').length,
            1,
            '"show" class added on click'
          );
          assert.strictEqual(
            $('#qunit-fixture .dropdown-menu.show').length,
            1,
  ...
  QUnit.test('should fire hide and hidden event with a clickEvent', function (
    assert
  ) {
    assert.expect(3);
    var dropdownHTML =
  ...
  QUnit.test(
    'should fire hide and hidden event without a clickEvent if event type is not click',
    function (assert) {
      assert.expect(3);
      var dropdownHTML =
        '<div class="tabs">' +
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $dropdown.parent('.dropdown').on('shown.bs.dropdown', function () {
        ...
        $textarea.trigger('focus').trigger(
          $.Event('keydown', {
            which: 38
          })
        );
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $dropdown.parent('.dropdown').on('shown.bs.dropdown', function () {
        ...
        assert.ok(
          $(document.activeElement).is($('#item1')),
          'item1 is focused'
        );
        ...
        assert.ok(
          $(document.activeElement).is($('#item2')),
          'item2 is focused'
        );
  ...
  QUnit.test('Dropdown should not use Popper.js in navbar', function (assert) {
    ...
    $triggerDropdown.parent('.dropdown').on('shown.bs.dropdown', function () {
      assert.ok(
        typeof $dropdownMenu.attr('style') === 'undefined',
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $dropdown.parent('.dropdown').on('shown.bs.dropdown', function () {
        ...
        assert.ok(
          $(document.activeElement)[0] === $input[0],
          'input still focused'
        );
        $textarea.trigger('focus').trigger(
          $.Event('keydown', {
        ...
        assert.ok(
          $(document.activeElement)[0] === $textarea[0],
          'textarea still focused'
        );
    ...
    function (assert) {
      ...
      $dropdown.parent('.dropdown').one('shown.bs.dropdown', function () {
        ...
        $dropdown.parent('.dropdown').one('shown.bs.dropdown', function () {
          ...
          assert.ok(
            document.activeElement === $('#item1')[0],
            'item1 is focused'
          );
  ...
  QUnit.test('should not use Popper.js if display set to static', function (
    assert
  ) {
    assert.expect(1);
    var dropdownHTML =
  ...
  QUnit.test('should call Popper.js and detect navbar on update', function (
    assert
  ) {
    assert.expect(3);
  ...
  QUnit.test('should prevent default event on show method call', function (
    assert
  ) {
    assert.expect(1);
  ...
  QUnit.test('should prevent default event on hide method call', function (
    assert
  ) {
    assert.expect(1);
  ...
  QUnit.test(
    'should not open dropdown via show method if target is disabled via attribute',
    function (assert) {
      assert.expect(1);
      var dropdownHTML =
        '<div class="dropdown">' +
  ...
  QUnit.test(
    'should not open dropdown via show method if target is disabled via class',
    function (assert) {
      assert.expect(1);
      var dropdownHTML =
        '<div class="dropdown">' +
  ...
  QUnit.test(
    'should not hide dropdown via hide method if target is disabled via attribute',
    function (assert) {
      assert.expect(1);
      var dropdownHTML =
  ...
  QUnit.test(
    'should not hide dropdown via hide method if target is disabled via class',
    function (assert) {
      assert.expect(1);
      var dropdownHTML =
        '<div class="dropdown show">' +
  ...
  QUnit.test(
    'should create offset modifier correctly when offset option is a function',
    function (assert) {
      assert.expect(2);
  ...
  QUnit.test(
    'should create offset modifier correctly when offset option is not a function',
    function (assert) {
      assert.expect(2);
